...
inst_db_entry_st inst_db[] = {
		/* ADC - Done */
		{ .opcode = 0x29, .n_cycles = 2, .sz = 2, .pc_adv = true,  .format = "ADC #$%02X",      .func = adc_immediate, },
		{ .opcode = 0x25, .n_cycles = 3, .sz = 2, .pc_adv = true,  .format = "ADC $%02X",       .func = adc_zero_page, },
		{ .opcode = 0x35, .n_cycles = 4, .sz = 2, .pc_adv = true,  .format = "ADC $%02X, X",    .func = adc_zero_page_x, },
		{ .opcode = 0x2D, .n_cycles = 4, .sz = 3, .pc_adv = true,  .format = "ADC $%04X",       .func = adc_absolute, },
		{ .opcode = 0x3D, .n_cycles = 4, .sz = 3, .pc_adv = true,  .format = "ADC $%04X, X",    .func = adc_absolute_x, },
		{ .opcode = 0x39, .n_cycles = 4, .sz = 3, .pc_adv = true,  .format = "ADC $%04X, Y",    .func = adc_absolute_y, },
		{ .opcode = 0x21, .n_cycles = 6, .sz = 2, .pc_adv = true,  .format = "ADC ($%02X, X)",  .func = adc_indirect_x, },
		{ .opcode = 0x31, .n_cycles = 5, .sz = 2, .pc_adv = true,  .format = "ADC ($%02X), Y",  .func = adc_indirect_y, },

		/* AND - Done */
		{ .opcode = 0x69, .n_cycles = 2, .sz = 2, .pc_adv = true,  .format = "AND #$%02X",      .func = and_immediate, },
		{ .opcode = 0x65, .n_cycles = 3, .sz = 2, .pc_adv = true,  .format = "AND $%02X",       .func = and_zero_page, },
		{ .opcode = 0x75, .n_cycles = 4, .sz = 2, .pc_adv = true,  .format = "AND $%02X, X",    .func = and_zero_page_x, },
		{ .opcode = 0x6D, .n_cycles = 4, .sz = 3, .pc_adv = true,  .format = "AND $%04X",       .func = and_absolute, },
		{ .opcode = 0x7D, .n_cycles = 4, .sz = 3, .pc_adv = true,  .format = "AND $%04X, X",    .func = and_absolute_x, },
		{ .opcode = 0x79, .n_cycles = 4, .sz = 3, .pc_adv = true,  .format = "AND $%04X, Y",    .func = and_absolute_y, },
		{ .opcode = 0x61, .n_cycles = 6, .sz = 2, .pc_adv = true,  .format = "AND ($%02X, X)",  .func = and_indirect_x, },
		{ .opcode = 0x71, .n_cycles = 5, .sz = 2, .pc_adv = true,  .format = "AND ($%02X), Y",  .func = and_indirect_y, },
		...
		{ .opcode = 0x40, .n_cycles = 4, .sz = 3, .pc_adv = true,  .format = "EOR $%04X",       .func = eor_absolute, },
